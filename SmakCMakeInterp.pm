...
sub _write_cmake_cache {
    ...
    print $fh "CMAKE_C_COMPILER:FILEPATH=" . $pick->('CMAKE_C_COMPILER', '/usr/bin/cc') . "\n";
    print $fh "CMAKE_CXX_COMPILER:FILEPATH=" . $pick->('CMAKE_CXX_COMPILER', '/usr/bin/c++') . "\n";
    print $fh "CMAKE_Fortran_COMPILER:FILEPATH=" . $pick->('CMAKE_Fortran_COMPILER', '/usr/bin/gfortran') . "\n";
